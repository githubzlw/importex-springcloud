...
public class CartServiceImpl implements CartService {
    ...
    private CartItem product2CartItem(SiteEnum site,Product product, long num, String[] split, Integer chk) {
        ...
        fillOthersInfoToProduct(product, cartItem, SiteEnum.HOME == site);
        return cartItem;
    }
     ...
     * @param cartItem
     */
    private void fillOthersInfoToProduct(Product product, CartItem cartItem, boolean isHome) {
        ...
        if (StringUtils.isNotBlank(product.getRange_price_free_new())) {
            ImmutablePair<Float, Long> weiAndPri = getWeiAndPri(product.getSku_new(), cartItem, isHome);
     ...
     * @return
     */
    private ImmutablePair<Float, Long> getWeiAndPri(String sku, CartItem cartItem, boolean isHome) {
