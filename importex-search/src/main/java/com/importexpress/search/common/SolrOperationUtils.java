...
@Slf4j
@Component
public class SolrOperationUtils {
    @Autowired
    private SynonumsUtils synonumsUtils;
    @Autowired
    ...
    public String queryKey(String queryString) {
        ...
        //多个搜索词------热卖搜索
        String synonymKey = synonumsUtils.moreKeys(queryString);

        //单个搜索词
        synonymKey = StringUtils.isBlank(synonymKey) ? synonumsUtils.synonymKey(queryString) : synonymKey;
        return synonymKey;
    }
